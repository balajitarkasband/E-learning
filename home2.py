...
class LearningPlatformHomePage:
    def __init__(self, root):
        ...
        self.signup_button = tk.Button(self.nav_frame, text="Signup", command=self.signup)
        self.signup_button.pack(side="right", padx=10)

        self.login_button = tk.Button(self.nav_frame, text="Login", command=self.login)
        self.login_button.pack(side="right", padx=10)
        
        self.instructor_button = tk.Button(self.nav_frame, text="Instructor", command=self.instructor_i)
        self.instructor_button.pack(side="right", padx=10)
        
        self.review_button = tk.Button(self.nav_frame, text="Review", command=self.review_1)
        self.review_button.pack(side="right", padx=10)
    ...
    def signup(self):
        ...
        root = tk.Tk()
        newregistration.RegistrationPage(root)
        root.mainloop()
        
    def instructor_i(self):
        self.root.destroy()
        import instructor
        root = tk.Tk()
        instructor.InstructorPage(root)
        root.mainloop() 
